...
from llambda.constants.cost_data import COST_MAPPING
...
class ResponseGenerator:
    ...
    async def estimate_token_cost(
        ...
        print(f"LLaMBDA: Estimating cost based on {count} generations per prompt...")

        if example_responses is None:
            print("LLaMBDA: Generating sample of responses for cost estimation...")
    ...
    async def generate_responses(
        ...
        ), "LLaMBDA: If using custom prompts, please ensure `prompts` is of type list[str]"
        print(f"LLaMBDA: Generating {count} responses per prompt...")
