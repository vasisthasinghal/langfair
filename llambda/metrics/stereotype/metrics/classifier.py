...
from llambda.metrics.utils.classifier_metrics import (
    ExpectedMaximum,
    Fraction,
    Probability,
)
...
class StereotypeClassifier:
    ...
    def evaluate(
        ...
        if not scores:
            print("LLaMBDA: Computing stereotype scores...")
        ...
        for category in self.categories:
            if prompts:
                assert prompts is not None, """
                    LLaMBDA: Prompts must be provided with corresponding responses for to evaluate toxicity metrics by prompt.
                """
    ...
    def _validate_categories(self, categories: List[str]) -> None:
        ...
        for category in categories:
            ...
            ), """LLaMBDA: Provided category name is not part of supported categories."""
